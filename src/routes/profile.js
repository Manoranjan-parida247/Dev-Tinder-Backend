...
const {validatePasswordData, validateProfileEditData} = require("../utils/validation")
const profileRouter = express.Router();

// GET /profile/view : protected route
profileRouter.get("/view", userAuth, async(req, res)=> {
    try{
        ...
        console.log("Error in fetching profile : " + err.message);
